...
function [Photosynthesis,Stomata,Weather,Constants,LeafBoundaryLayer,...
    EnergyOptions] = callInputDataAll(fileName)
...
Weather = table2struct(Weather,"ToScalar",true);
Stomata = table2struct(Stomata,"ToScalar",true);
Photosynthesis = table2struct(Photosynthesis,"ToScalar",true);
end