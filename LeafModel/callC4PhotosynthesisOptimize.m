...
%% vc limited rate
LeafMassFlux.vcCO2 = LeafState.cbs*LeafMassFlux.vcmax/(LeafState.cbs+LeafState.Kc*(1.0+LeafState.obs/LeafState.Ko)); % CO2 limited RUBISCO carboxylation rate (vonCaemmerer 2000)% Oxygen conc. at bundle sheath [u moles m-2 s-1]
LeafMassFlux.vcLight = (1.0 - Photosynthesis.x) * LeafState.cbs * LeafMassFlux.J...
    /(3.0 * LeafState.cbs + 7.0 * LeafState.GammaStar); % Light limited RUBISCO carboxylation rate (vonCaemmerer 2000)[u moles m-2 s-1]
